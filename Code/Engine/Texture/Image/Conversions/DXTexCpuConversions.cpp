...
plImageConversionEntry g_DXTexCpuConversions[] = {
  ...
  plImageConversionEntry(plImageFormat::R8G8B8A8_UNORM, plImageFormat::BC1_UNORM, plImageConversionFlags::Default, 100),
  plImageConversionEntry(plImageFormat::R8G8B8A8_UNORM, plImageFormat::BC7_UNORM, plImageConversionFlags::Default, 100),

  plImageConversionEntry(plImageFormat::R8G8B8A8_UNORM_SRGB, plImageFormat::BC1_UNORM_SRGB, plImageConversionFlags::Default, 100),
  plImageConversionEntry(plImageFormat::R8G8B8A8_UNORM_SRGB, plImageFormat::BC7_UNORM_SRGB, plImageConversionFlags::Default, 100),
};
