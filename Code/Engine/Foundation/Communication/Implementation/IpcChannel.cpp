...
static_assert((plInt32)plIpcChannel::ConnectionState::Disconnected == (plInt32)plIpcChannelEvent::Disconnected);
static_assert((plInt32)plIpcChannel::ConnectionState::Connecting == (plInt32)plIpcChannelEvent::Connecting);
static_assert((plInt32)plIpcChannel::ConnectionState::Connected == (plInt32)plIpcChannelEvent::Connected);
