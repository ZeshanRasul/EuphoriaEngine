...
plExpressionFunction plDefaultExpressionFunctions::s_RandomFunc = {
  {plMakeHashedString("Random"), plExpression::FunctionDesc::TypeList(s_RandomInputTypes), 1, RegisterType::Float},
  &Random,
};

plExpressionFunction plDefaultExpressionFunctions::s_PerlinNoiseFunc = {
  {plMakeHashedString("PerlinNoise"), plExpression::FunctionDesc::TypeList(s_PerlinNoiseInputTypes), 3, RegisterType::Float},
  &PerlinNoise,
};
...
PL_STATICLINK_FILE(Foundation, Foundation_CodeUtils_Expression_Implementation_ExpressionDeclarations);
