...
#define DEFINE_CONSTANT(name)                                                      \
  const plUInt32 PL_PP_CONCAT(name, Raw) = *pByteCode;                             \
  PL_IGNORE_UNUSED(PL_PP_CONCAT(name, Raw));                                       \
...
#define DEFINE_UNARY_OP(name, code)                                                      \
  void PL_PP_CONCAT(name, _4)(const ByteCodeType*& pByteCode, ExecutionContext& context) \
  {                                                                                      \
