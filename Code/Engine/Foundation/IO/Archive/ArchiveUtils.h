...
namespace plArchiveUtils
{
  ...
  constexpr plUInt32 ArchiveTOCMetaMaxFooterSize = 14 + 12; //< note that it's the MAX size, i.e. toc meta can be smaller

  struct TOCMeta
  {
    plUInt32 m_uiTocSize = 0;
    plUInt64 m_uiExpectedTocHash = 0;
    plUInt32 m_uiTocOffsetFromArchiveEnd = 0;
  };
  ...
  PL_FOUNDATION_DLL plResult WriteEntryPreprocessed(plStreamWriter& inout_stream, plConstByteArrayPtr entryData, plUInt32 uiPathStringOffset,
    plArchiveCompressionMode compression, plUInt32 uiUncompressedEntryDataSize, plArchiveEntry& ref_tocEntry, plUInt64& inout_uiCurrentStreamPosition);
