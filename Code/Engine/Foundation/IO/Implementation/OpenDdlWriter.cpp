...
{
  static_assert((int)plOpenDdlWriter::State::PrimitivesBool == (int)plOpenDdlPrimitiveType::Bool);
  static_assert((int)plOpenDdlWriter::State::PrimitivesInt8 == (int)plOpenDdlPrimitiveType::Int8);
  static_assert((int)plOpenDdlWriter::State::PrimitivesInt16 == (int)plOpenDdlPrimitiveType::Int16);
  static_assert((int)plOpenDdlWriter::State::PrimitivesInt32 == (int)plOpenDdlPrimitiveType::Int32);
  static_assert((int)plOpenDdlWriter::State::PrimitivesInt64 == (int)plOpenDdlPrimitiveType::Int64);
  static_assert((int)plOpenDdlWriter::State::PrimitivesUInt8 == (int)plOpenDdlPrimitiveType::UInt8);
  static_assert((int)plOpenDdlWriter::State::PrimitivesUInt16 == (int)plOpenDdlPrimitiveType::UInt16);
  static_assert((int)plOpenDdlWriter::State::PrimitivesUInt32 == (int)plOpenDdlPrimitiveType::UInt32);
  static_assert((int)plOpenDdlWriter::State::PrimitivesUInt64 == (int)plOpenDdlPrimitiveType::UInt64);
  static_assert((int)plOpenDdlWriter::State::PrimitivesFloat == (int)plOpenDdlPrimitiveType::Float);
  static_assert((int)plOpenDdlWriter::State::PrimitivesString == (int)plOpenDdlPrimitiveType::String);
