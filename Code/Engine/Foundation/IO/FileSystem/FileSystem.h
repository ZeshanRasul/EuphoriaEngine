...
public:
  ...
  static plResult AddDataDirectory(plStringView sDataDirectory, plStringView sGroup = {}, plStringView sRootName = {}, plDataDirUsage usage = plDataDirUsage::ReadOnly); // [tested]
  ...
  static const plDataDirectoryInfo* FindDataDirectoryWithRoot(plStringView sRootName);
  ...
  static const plDataDirectoryInfo& GetDataDirectoryInfo(plUInt32 uiDataDirIndex);
...
public:
  ...
  static plResult ResolvePath(plStringView sPath, plStringBuilder* out_pAbsolutePath, plStringBuilder* out_pDataDirRelativePath, const plDataDirectoryInfo** out_pDataDir = nullptr); // [tested]
...
private:
  ...
  struct FileSystemData
  {
    ...
    plHybridArray<plDataDirectoryInfo, 16> m_DataDirectories;
  ...
  static plDataDirectoryInfo* GetDataDirForRoot(const plString& sRoot);
