...
public:
  ...
  plDirectoryWatcher();
  plDirectoryWatcher(const plDirectoryWatcher&) = delete;
  plDirectoryWatcher(plDirectoryWatcher&&) noexcept = delete;
  ~plDirectoryWatcher();

  plDirectoryWatcher& operator=(const plDirectoryWatcher&) = delete;
  plDirectoryWatcher& operator=(plDirectoryWatcher&&) noexcept = delete;
