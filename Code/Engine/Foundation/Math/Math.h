...
namespace plMath
{
  ...
  [[nodiscard]] constexpr plUInt32 WrapUInt(plUInt32 uiValue, plUInt32 uiExcludedMaxValue); // [tested]
  ...
  /// A value of 0 for uiExcludedMaxValue is invalid and results in a division by zero error.
  [[nodiscard]] constexpr plInt32 WrapInt(plInt32 iValue, plUInt32 uiExcludedMaxValue); // [tested]
  ...
  [[nodiscard]] constexpr plInt32 WrapInt(plInt32 iValue, plInt32 iMinValue, plInt32 iExcludedMaxValue); // [tested]
  ...
  [[nodiscard]] plInt32 FloorToInt(float f); // [tested]
  ...
  [[nodiscard]] plInt32 CeilToInt(float f); // [tested]
  ...
  [[nodiscard]] plInt32 RoundToInt(float f); // [tested]
