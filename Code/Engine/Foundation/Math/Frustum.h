...
public:
  ...
  [[nodiscard]] static plFrustum MakeInvalid();
  ...
  [[nodiscard]] static plResult TryMakeFromPlanes(plFrustum& out_frustum, const plPlane* pPlanes);
  ...
  ///
  /// Returns PL_SUCESS with a valid outFrustum if the operation was successful and PL_FAILURE otherwise.
  [[nodiscard]] static plResult TryMakeFromMVP(plFrustum& out_frustum, const plMat4& mModelViewProjection, plClipSpaceDepthRange::Enum depthRange = plClipSpaceDepthRange::Default, plHandedness::Enum handedness = plHandedness::Default);
  ...
  ///
  /// Returns PL_SUCESS with a valid outFrustum if the operation was successful and PL_FAILURE otherwise.
  [[nodiscard]] static plResult TryMakeFromFOV(plFrustum& out_frustum, const plVec3& vPosition, const plVec3& vForwards, const plVec3& vUp, plAngle fovX, plAngle fovY, float fNearPlane, float fFarPlane);
  ...
  ///
  /// Returns PL_SUCESS with a valid outFrustum if the operation was successful and PL_FAILURE otherwise.
  [[nodiscard]] static plResult TryMakeFromCorners(plFrustum& out_frustum, const plVec3 pCorners[FrustumCorner::CORNER_COUNT]);
  ...
  plFrustum GetTransformedFrustum(const plMat4& mTransform) const; // [tested]
