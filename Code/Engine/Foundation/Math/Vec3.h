...
public:
  ...
  [[nodiscard]] static plVec3Template<Type> Make(Type x, Type y, Type z) { return plVec3Template<Type>(x, y, z); } // [tested]
...
public:
  ...
  PL_DECLARE_IF_FLOAT_TYPE
  [[nodiscard]] const plVec3Template<Type> GetNormalized() const; // [tested]
...
public:
  ...
  [[nodiscard]] Type Dot(const plVec3Template<Type>& rhs) const; // [tested]



  /// \brief Returns the Cross-product of the two vectors (NOT commutative, order DOES matter)
  [[nodiscard]] const plVec3Template<Type> CrossRH(const plVec3Template<Type>& rhs) const; // [tested]

  /// \brief Returns the component-wise minimum of *this and rhs
  [[nodiscard]] const plVec3Template<Type> CompMin(const plVec3Template<Type>& rhs) const; // [tested]

  /// \brief Returns the component-wise maximum of *this and rhs
  [[nodiscard]] const plVec3Template<Type> CompMax(const plVec3Template<Type>& rhs) const; // [tested]

  /// \brief Returns the component-wise clamped value of *this between low and high.
  [[nodiscard]] const plVec3Template<Type> CompClamp(const plVec3Template<Type>& vLow, const plVec3Template<Type>& vHigh) const; // [tested]

  /// \brief Returns the component-wise multiplication of *this and rhs
  [[nodiscard]] const plVec3Template<Type> CompMul(const plVec3Template<Type>& rhs) const; // [tested]

  /// \brief Returns the component-wise division of *this and rhs
  [[nodiscard]] const plVec3Template<Type> CompDiv(const plVec3Template<Type>& rhs) const; // [tested]

  /// brief Returns the component-wise absolute of *this.
  [[nodiscard]] const plVec3Template<Type> Abs() const; // [tested]
...
public:
  ...
  PL_DECLARE_IF_FLOAT_TYPE
  [[nodiscard]] static plVec3Template<Type>
  MakeRandomPointInSphere(plRandom& inout_rng); // [tested]

  /// \brief Creates a random direction vector. The vector is normalized.
  PL_DECLARE_IF_FLOAT_TYPE
  [[nodiscard]] static plVec3Template<Type>
  MakeRandomDirection(plRandom& inout_rng); // [tested]
  ...
  PL_DECLARE_IF_FLOAT_TYPE
  [[nodiscard]] static plVec3Template<Type>
  MakeRandomDeviationX(plRandom& inout_rng, const plAngle& maxDeviation); // [tested]
  ...
  PL_DECLARE_IF_FLOAT_TYPE
  [[nodiscard]] static plVec3Template<Type>
  MakeRandomDeviationY(plRandom& inout_rng, const plAngle& maxDeviation); // [tested]
  ...
  PL_DECLARE_IF_FLOAT_TYPE
  [[nodiscard]] static plVec3Template<Type>
  MakeRandomDeviationZ(plRandom& inout_rng, const plAngle& maxDeviation); // [tested]
  ...
  PL_DECLARE_IF_FLOAT_TYPE
  [[nodiscard]] static plVec3Template<Type>
  MakeRandomDeviation(plRandom& inout_rng, const plAngle& maxDeviation, const plVec3Template<Type>& vNormal); // [tested]
};
