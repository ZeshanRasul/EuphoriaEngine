...
template <typename Type>
PL_ALWAYS_INLINE const float plVec3Template<Type>::GetX() const
{
  return x;
}

template <typename Type>
PL_ALWAYS_INLINE const float plVec3Template<Type>::GetY() const
{
  return y;
}

template <typename Type>
PL_ALWAYS_INLINE const float plVec3Template<Type>::GetZ() const
{
  return z;
}
