...
public:
  ...
  /// \brief Creates a quaternion that will rotate vRotator towards vTarget.
  /// \param vTarget This is the target object you want to look at.
  /// \param vCurrentRot This is the current rotation of the object.
  /// \param fMaxAngularSpeed This is the maximum angular speed the object can rotate at. Ensure this is scaled by delta.
  /// \param vAxis This is the axis around which the object should rotate. Defaults to (0,0,1)
  [[nodiscard]] static plQuatTemplate<Type> MakeRotationTowardsTarget(const plVec3Template<Type>& vTargetDir, const plQuatTemplate<Type>& vCurrentRot, const float fMaxAngularSpeed, const plVec3Template<Type>& vAxis = plVec3Template<Type>(0, 0, 1));
