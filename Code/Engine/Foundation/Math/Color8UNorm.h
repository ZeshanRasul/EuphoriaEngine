...
static_assert(sizeof(plColorBaseUB) == 4);
...
public:
  ...
  {
    return plColorLinearUB(static_cast<plUInt8>(value >> 0) & 0xFF,
      static_cast<plUInt8>(value >> 8) & 0xFF,
      static_cast<plUInt8>(value >> 16) & 0xFF,
      static_cast<plUInt8>(value >> 24) & 0xFF);
  }
};

static_assert(sizeof(plColorLinearUB) == 4);
...
static_assert(sizeof(plColorGammaUB) == 4);
