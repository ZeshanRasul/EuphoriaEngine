...
PL_BEGIN_STATIC_REFLECTED_TYPE(plVec3, plNoBase, 1, plRTTINoAllocator)
{
  ...
  PL_BEGIN_FUNCTIONS
  {
    PL_CONSTRUCTOR_PROPERTY(float),
    PL_CONSTRUCTOR_PROPERTY(float, float, float),
    PL_SCRIPT_FUNCTION_PROPERTY(Make, In, "X", In, "Y", In, "Z")->AddFlags(plPropertyFlags::Const),
    PL_SCRIPT_FUNCTION_PROPERTY(GetLength<float>),
    PL_SCRIPT_FUNCTION_PROPERTY(GetLengthSquared),
    PL_SCRIPT_FUNCTION_PROPERTY(GetNormalized<float>),
    PL_SCRIPT_FUNCTION_PROPERTY(Dot, In, "v"),
    PL_SCRIPT_FUNCTION_PROPERTY(CrossRH, In, "v"),
    PL_SCRIPT_FUNCTION_PROPERTY(GetAngleBetween, In, "v"),
    PL_SCRIPT_FUNCTION_PROPERTY(GetX),
    PL_SCRIPT_FUNCTION_PROPERTY(GetY),
    PL_SCRIPT_FUNCTION_PROPERTY(GetZ),
  }
  PL_END_FUNCTIONS;
}
PL_END_STATIC_REFLECTED_TYPE;
...
PL_BEGIN_STATIC_REFLECTED_TYPE(plQuat, plNoBase, 1, plRTTINoAllocator)
{
  ...
  PL_BEGIN_FUNCTIONS
  {
    ...
    PL_SCRIPT_FUNCTION_PROPERTY(MakeSlerp, In, "From", In, "To", In, "Lerp")->AddFlags(plPropertyFlags::Const),
    PL_SCRIPT_FUNCTION_PROPERTY(GetInverse),
    PL_SCRIPT_FUNCTION_PROPERTY(Rotate, In, "v"),
  }
  PL_END_FUNCTIONS;
}
PL_END_STATIC_REFLECTED_TYPE;
