...
#undef CALL_FUNCTOR
  ...
  struct SetComponentValueImpl
  {
    ...
    {
      PL_IGNORE_UNUSED(pVector);
      PL_IGNORE_UNUSED(uiComponent);
      PL_IGNORE_UNUSED(fValue);
      PL_ASSERT_DEBUG(false, "plReflectionUtils::SetComponent was called with a non-vector variant '{0}'", pVector->GetType());
    }
  };
  ...
  struct SetComponentValueImpl<plVec2Template<T>>
  {
    PL_FORCE_INLINE static void impl(plVariant* pVector, plUInt32 uiComponent, double fValue)
    {
      PL_ASSERT_DEBUG(uiComponent < 2, "uiComponent out of range");
  ...
  struct SetComponentValueImpl<plVec3Template<T>>
  {
    PL_FORCE_INLINE static void impl(plVariant* pVector, plUInt32 uiComponent, double fValue)
    {
      PL_ASSERT_DEBUG(uiComponent < 3, "uiComponent out of range");
  ...
  struct SetComponentValueImpl<plVec4Template<T>>
  {
    PL_FORCE_INLINE static void impl(plVariant* pVector, plUInt32 uiComponent, double fValue)
    {
      PL_ASSERT_DEBUG(uiComponent < 4, "uiComponent out of range");
  ...
  {
    PL_FORCE_INLINE static void impl(const plVariant* pVector, plUInt32 uiComponent, double& out_fValue)
    {
      PL_IGNORE_UNUSED(pVector);
      PL_IGNORE_UNUSED(uiComponent);
      PL_IGNORE_UNUSED(out_fValue);
      PL_ASSERT_DEBUG(false, "plReflectionUtils::SetComponent was called with a non-vector variant '{0}'", pVector->GetType());
    }
  };
