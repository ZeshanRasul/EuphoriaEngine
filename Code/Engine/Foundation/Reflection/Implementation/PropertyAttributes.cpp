...
PL_BEGIN_DYNAMIC_REFLECTED_TYPE(plIconAttribute, 1, plRTTIDefaultAllocator<plIconAttribute>)
{
  PL_BEGIN_PROPERTIES
  {
    PL_MEMBER_PROPERTY("Icon", m_sIcon),
  }
  PL_END_PROPERTIES;
  PL_BEGIN_FUNCTIONS
  {
...
PL_BEGIN_DYNAMIC_REFLECTED_TYPE(plAssetBrowserAttribute, 1, plRTTIDefaultAllocator<plAssetBrowserAttribute>)
{
  ...
  {
    PL_MEMBER_PROPERTY("Filter", m_sTypeFilter),
    PL_MEMBER_PROPERTY("RequiredTag", m_sRequiredTag),
    PL_BITFLAGS_MEMBER_PROPERTY("DependencyFlags", plDependencyFlags, m_DependencyFlags),
  }
  PL_END_PROPERTIES;
  PL_BEGIN_FUNCTIONS
  {
    PL_CONSTRUCTOR_PROPERTY(const char*),
    PL_CONSTRUCTOR_PROPERTY(const char*, plBitflags<plDependencyFlags>),
    PL_CONSTRUCTOR_PROPERTY(const char*, const char*),
    PL_CONSTRUCTOR_PROPERTY(const char*, const char*, plBitflags<plDependencyFlags>),
  }
  PL_END_FUNCTIONS;
}
PL_END_DYNAMIC_REFLECTED_TYPE;
...
PL_BEGIN_DYNAMIC_REFLECTED_TYPE(plFunctionArgumentAttributes, 1, plRTTIDefaultAllocator<plFunctionArgumentAttributes>)
{
  PL_BEGIN_PROPERTIES
  {
    ...
    PL_ARRAY_MEMBER_PROPERTY("ArgAttributes", m_ArgAttributes)->AddFlags(plPropertyFlags::PointerOwner),
  }
  PL_END_PROPERTIES;
}
PL_END_DYNAMIC_REFLECTED_TYPE;
...
plFunctionArgumentAttributes::~plFunctionArgumentAttributes()
{
  for (auto pAttribute : m_ArgAttributes)
  {
    auto pAttributeNonConst = const_cast<plPropertyAttribute*>(pAttribute);
    PL_DEFAULT_DELETE(pAttributeNonConst);
  }
}
