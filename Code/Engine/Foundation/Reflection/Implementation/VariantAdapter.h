...
template <class T>
struct plVariantAdapter<T, plStringView, 1, 0>
{
  plVariantAdapter(plVariant& value)
    : m_value(value)
  {
  ...
  operator const plStringView() { return m_value.IsA<plStringView>() ? m_value.Get<plStringView>() : m_value.Get<plString>().GetView(); }
