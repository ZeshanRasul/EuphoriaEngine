...
#define PL_FUNCTION_PROPERTY(Function) (new plFunctionProperty<decltype(&OwnType::Function)>(PL_PP_STRINGIFY(Function), &OwnType::Function))
...
// [internal] Helper macro
#define PL_ENUM_VALUE_TO_CONSTANT_PROPERTY(name) PL_CONSTANT_PROPERTY(PL_PP_STRINGIFY(name), (Storage)name),
...
#define PL_ENUM_CONSTANT(Value) PL_CONSTANT_PROPERTY(PL_PP_STRINGIFY(Value), (Storage)Value)
...
#define PL_BITFLAGS_CONSTANT(Value) PL_CONSTANT_PROPERTY(PL_PP_STRINGIFY(Value), (Storage)Value)
...
#define PL_BEGIN_STATIC_REFLECTED_ENUM(Type, Version)                          \
  PL_BEGIN_STATIC_REFLECTED_TYPE(Type, plEnumBase, Version, plRTTINoAllocator) \
    ...
    PL_BEGIN_PROPERTIES                                                        \
      {                                                                        \
        PL_CONSTANT_PROPERTY(PL_PP_STRINGIFY(Type::Default), (Storage)Type::Default),
