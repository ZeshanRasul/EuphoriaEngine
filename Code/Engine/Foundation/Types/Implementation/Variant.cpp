...
static_assert(sizeof(plVariant) == 24);
#else
static_assert(sizeof(plVariant) == 20);
#endif
...
struct ComputeHashFunc
{
  ...
  {
    PL_IGNORE_UNUSED(v);
    static_assert(sizeof(typename plVariant::TypeDeduction<T>::StorageType) <= sizeof(float) * 4 &&
