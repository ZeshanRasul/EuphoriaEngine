...
#define PL_DEFINE_CUSTOM_VARIANT_TYPE(TYPE)                                                                                                                         \
  static_assert(plVariantTypeDeduction<TYPE>::value == plVariantType::TypedObject, "PL_DECLARE_CUSTOM_VARIANT_TYPE needs to be added to the header defining TYPE"); \
