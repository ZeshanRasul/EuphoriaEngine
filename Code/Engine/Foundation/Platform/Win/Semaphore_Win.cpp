...
plResult plSemaphore::TryAcquireToken(plTime timeout)
{
  PL_ASSERT_DEV(m_hSemaphore != nullptr, "Invalid semaphore.");

  const plUInt32 res = WaitForSingleObject(m_hSemaphore, plMath::FloatToInt(timeout.AsFloatInSeconds() * 1000));
