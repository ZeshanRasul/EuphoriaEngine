...
plUInt32 plStringUtils::CopyN(char* szDest, plUInt32 uiDstSize, const char* szSource, plUInt32 uiCharsToCopy, const char* pSourceEnd)
{
  ...
  *szLastCharacterPos = '\0';
  ...
  return (plUInt32)(szLastCharacterPos - szStartPos);
}
...
plUInt32 plStringUtils::CalculateLineNumber(const char* szString, const char* szOffset, const char* pStringEnd /*= plUnicodeUtils::GetMaxStringEnd<char>()*/)
{
  plUInt32 uiLine = 0;
