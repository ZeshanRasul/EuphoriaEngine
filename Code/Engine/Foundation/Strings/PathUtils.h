...
public:
  ...
  static plStringView GetFileExtension(plStringView sPath, bool bFullExtension = false); // [tested]
  ...
  static plStringView GetFileName(plStringView sPath, bool bRemoveFullExtension = false); // [tested]
