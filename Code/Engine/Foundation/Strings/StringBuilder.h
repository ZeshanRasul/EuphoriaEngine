...
public:
  ...
  void Set(plStringView sData1); // [tested]
  /// \brief Sets the string by concatenating all given strings.
  void Set(plStringView sData1, plStringView sData2); // [tested]
  /// \brief Sets the string by concatenating all given strings.
  void Set(plStringView sData1, plStringView sData2, plStringView sData3); // [tested]
  /// \brief Sets the string by concatenating all given strings.
  void Set(plStringView sData1, plStringView sData2, plStringView sData3, plStringView sData4); // [tested]
  /// \brief Sets the string by concatenating all given strings.
  void Set(plStringView sData1, plStringView sData2, plStringView sData3, plStringView sData4, plStringView sData5, plStringView sData6 = {}); // [tested]
  ...
  void Append(plStringView sData1); // [tested]
  /// \brief Appends all the given strings to the back of this string in one operation.
  void Append(plStringView sData1, plStringView sData2); // [tested]
  /// \brief Appends all the given strings to the back of this string in one operation.
  void Append(plStringView sData1, plStringView sData2, plStringView sData3); // [tested]
  /// \brief Appends all the given strings to the back of this string in one operation.
  void Append(plStringView sData1, plStringView sData2, plStringView sData3, plStringView sData4); // [tested]
  /// \brief Appends all the given strings to the back of this string in one operation.
  ...
  void ChangeFileExtension(plStringView sNewExtension, bool bFullExtension = false); // [tested]
