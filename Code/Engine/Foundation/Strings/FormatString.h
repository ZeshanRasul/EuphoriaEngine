...
/// Good examples are plStringBuilder::SetFormat() or plLog::Info().
///
...
///
/// Example:
///   plStringBuilder::SetFormat("HEX: {}", plArgU(1337, 8 /*width*/, true /*pad with zeros*/, 16 /*base16*/, true/*upper case*/));
///
