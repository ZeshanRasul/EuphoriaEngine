...
void plSetBase<KeyType, Comparer>::IteratorBase<REVERSE>::Advance(plInt32 dir0, plInt32 dir1)
{
...
template <typename KeyType, typename Comparer>
template <bool REVERSE>
void plSetBase<KeyType, Comparer>::IteratorBase<REVERSE>::Next()
{
...
template <typename KeyType, typename Comparer>
template <bool REVERSE>
void plSetBase<KeyType, Comparer>::IteratorBase<REVERSE>::Prev()
{
  if constexpr (REVERSE)
  {
    Advance(0, 1);
...
template <typename KeyType, typename Comparer>
PL_ALWAYS_INLINE typename plSetBase<KeyType, Comparer>::ReverseIterator plSetBase<KeyType, Comparer>::GetReverseIterator() const
{
