...
template <typename T>
typename plListBase<T>::ListElement* plListBase<T>::AcquireNode()
{
  ListElement* pNode;
...
template <typename T>
PL_ALWAYS_INLINE T& plListBase<T>::PushBack()
{
...
template <typename T>
PL_ALWAYS_INLINE T& plListBase<T>::PushFront()
{
...
template <typename T>
typename plListBase<T>::Iterator plListBase<T>::Insert(const Iterator& pos)
{
