...
template <typename T, plUInt16 Size>
PL_ALWAYS_INLINE bool plSmallArrayBase<T, Size>::operator<(const plArrayPtr<const T>& rhs) const
{
...
void plSmallArrayBase<T, Size>::SetCountUninitialized(plUInt16 uiCount, plAllocator* pAllocator)
{
  ...
  const plUInt16 uiOldCount = m_uiCount;
  const plUInt16 uiNewCount = uiCount;
...
template <typename T, plUInt16 Size, typename AllocatorWrapper /*= plDefaultAllocatorWrapper*/>
PL_ALWAYS_INLINE void plSmallArray<T, Size, AllocatorWrapper>::InsertAt(plUInt32 uiIndex, const T& value)
{
  SUPER::Insert(value, uiIndex, AllocatorWrapper::GetAllocator());
}

template <typename T, plUInt16 Size, typename AllocatorWrapper /*= plDefaultAllocatorWrapper*/>
PL_ALWAYS_INLINE void plSmallArray<T, Size, AllocatorWrapper>::InsertAt(plUInt32 uiIndex, T&& value)
{
  SUPER::Insert(value, uiIndex, AllocatorWrapper::GetAllocator());
}
