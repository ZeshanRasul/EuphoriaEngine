...
#define PL_CONSOLEAPP_ENTRY_POINT(AppClass, ...)                                                \
  ...
  {                                                                                             \
    return plApplicationDetails::ConsoleEntry<AppClass>(argc, argv, __VA_ARGS__);               \
  }
...
#define PL_APPLICATION_ENTRY_POINT(AppClass, ...)                                                                                \
  ...
  PL_APPLICATION_ENTRY_POINT_CODE_INJECTION                                                                                      \
  int PL_WINDOWS_CALLBACK WinMain(_In_ PL_PP_CONCAT(_PL_, PL_PP_CONCAT(APPLICATION_ENTRY_POINT_HINSTANCE, _WINDOWS_)) hInstance, \
    _In_opt_ PL_PP_CONCAT(_PL_, PL_PP_CONCAT(APPLICATION_ENTRY_POINT_HINSTANCE, _WINDOWS_)) hPrevInstance,                       \
    _In_ PL_PP_CONCAT(_PL_, PL_PP_CONCAT(APPLICATION_ENTRY_POINT_LPSTR, _WINDOWS_)) lpCmdLine, _In_ int nCmdShow)                \
  {                                                                                                                              \
