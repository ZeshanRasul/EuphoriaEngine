...
template<>
struct plJniTraits<plJniNullPtr>
{

  static inline bool AppendSignature(const plJniNullPtr& object, plStringBuilder& str)
  {
    str.Append("L");
  ...
  static inline jvalue ToValue(const plJniNullPtr& object)
  {
    jvalue j;
    j.l = nullptr;
    return j;
  ...
  static inline plJniClass GetRuntimeType(const plJniNullPtr& arg)
  {
    return plJniClass(arg.GetTypeSignature().GetData());
  }
};
