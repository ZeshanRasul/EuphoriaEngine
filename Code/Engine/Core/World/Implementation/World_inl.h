...
{
  static_assert(PL_IS_DERIVED_FROM_STATIC(plWorldModule, ModuleType), "Not a valid module type");
...
{
  static_assert(PL_IS_DERIVED_FROM_STATIC(plComponentManagerBase, ManagerType), "Not a valid component manager type");
