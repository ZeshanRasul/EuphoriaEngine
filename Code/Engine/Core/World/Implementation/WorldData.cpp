...
namespace plInternal
{
  ...
  public:
    ...
    {
      PL_IGNORE_UNUSED(vGlobalPosition);
...

  {
    ...
    static_assert(sizeof(plGameObject::TransformationData) == 240);
#else
    static_assert(sizeof(plGameObject::TransformationData) == 192);
#endif

    static_assert(sizeof(plGameObject) == 128);
    static_assert(sizeof(QueuedMsgMetaData) == 16);
    static_assert(PL_COMPONENT_TYPE_INDEX_BITS <= sizeof(plWorldModuleTypeId) * 8);
