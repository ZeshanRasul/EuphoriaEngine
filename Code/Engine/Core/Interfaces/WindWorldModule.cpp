...
plSimdVec4f plWindWorldModuleInterface::GetWindAtSimd(const plSimdVec4f& vPosition) const
{
  return plSimdConversion::ToVec3(GetWindAt(plSimdConversion::ToVec3(vPosition)));
}
