...
PL_BEGIN_STATIC_REFLECTED_TYPE(plPhysicsCastResult, plNoBase, 1, plRTTINoAllocator)
{
  PL_BEGIN_PROPERTIES
  {
    PL_MEMBER_PROPERTY("Position", m_vPosition),
    PL_MEMBER_PROPERTY("Normal", m_vNormal),
    PL_MEMBER_PROPERTY("Distance", m_fDistance),
    PL_MEMBER_PROPERTY("ShapeObject", m_hShapeObject),
    PL_MEMBER_PROPERTY("ActorObject", m_hActorObject),
