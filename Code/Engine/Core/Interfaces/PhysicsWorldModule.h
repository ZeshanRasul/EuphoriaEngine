...
public:
  ...
  {
    PL_IGNORE_UNUSED(pOwner);
    PL_IGNORE_UNUSED(vBoxSize);
  }
  ...
  {
    PL_IGNORE_UNUSED(pOwner);
    PL_IGNORE_UNUSED(uiCollisionLayer);
    PL_IGNORE_UNUSED(shapeTypes);
    PL_IGNORE_UNUSED(bIncludeChildObjects);
    return plBoundingBoxSphere::MakeInvalid();
  }
};
