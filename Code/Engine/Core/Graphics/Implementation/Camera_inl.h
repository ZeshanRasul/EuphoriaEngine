...
PL_ALWAYS_INLINE float plCamera::GetShutterSpeed() const
{
  return m_fShutterSpeed;
}

PL_ALWAYS_INLINE void plCamera::SetShutterSpeed(float fShutterSpeed)
{
...
PL_ALWAYS_INLINE float plCamera::GetAperture() const
{
  return m_fAperture;
}

PL_ALWAYS_INLINE void plCamera::SetAperture(float fAperture)
{
  m_fAperture = fAperture;
}

PL_ALWAYS_INLINE float plCamera::GetISO() const
{
  return m_fISO;
}

PL_ALWAYS_INLINE void plCamera::SetISO(float fISO)
{
  m_fISO = fISO;
}


PL_ALWAYS_INLINE float plCamera::GetFocusDistance() const
{
  return m_fFocusDistance;
}

PL_ALWAYS_INLINE void plCamera::SetFocusDistance(float fFocusDistance)
{
