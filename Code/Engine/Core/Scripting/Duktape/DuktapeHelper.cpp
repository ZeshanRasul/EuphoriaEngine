...
static_assert(plDuktapeTypeMask::None == DUK_TYPE_MASK_NONE);
static_assert(plDuktapeTypeMask::Undefined == DUK_TYPE_MASK_UNDEFINED);
static_assert(plDuktapeTypeMask::Null == DUK_TYPE_MASK_NULL);
static_assert(plDuktapeTypeMask::Bool == DUK_TYPE_MASK_BOOLEAN);
static_assert(plDuktapeTypeMask::Number == DUK_TYPE_MASK_NUMBER);
static_assert(plDuktapeTypeMask::String == DUK_TYPE_MASK_STRING);
static_assert(plDuktapeTypeMask::Object == DUK_TYPE_MASK_OBJECT);
static_assert(plDuktapeTypeMask::Buffer == DUK_TYPE_MASK_BUFFER);
static_assert(plDuktapeTypeMask::Pointer == DUK_TYPE_MASK_POINTER);
