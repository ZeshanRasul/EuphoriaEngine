...
macro(pl_pull_config_vars)
	...
	get_property(PL_CONFIG_VULKAN_VALIDATIONLAYERS_VERSION GLOBAL PROPERTY PL_CONFIG_VULKAN_VALIDATIONLAYERS_VERSION)
	get_property(PL_CONFIG_VULKAN_VALIDATIONLAYERS_ANDROID_URL GLOBAL PROPERTY PL_CONFIG_VULKAN_VALIDATIONLAYERS_ANDROID_URL)
endmacro()
...
function(pl_set_project_ide_folder TARGET_NAME PROJECT_SOURCE_DIR)
	...
	if(PL_SUBMODULE_MODE)
		set_property(TARGET ${TARGET_NAME} PROPERTY FOLDER "${PL_SUBMODULE_ROOT_IDE_FOLDER}/${IDE_FOLDER}")
	else()
...
# #####################################
# ## pl_create_link(<source> <destination-folder> <destination-name>)
# #####################################
function(pl_create_link SOURCE DEST_FOLDER DEST_NAME)
...
# #####################################
# ## pl_package_files(TARGET_NAME SRC_FOLDER DST_FOLDER)
# #####################################
#
...
# Internally it just forwards to pl_platformhook_package_files.
# #####################################
function(pl_package_files TARGET_NAME SRC_FOLDER DST_FOLDER)
	if (COMMAND pl_platformhook_package_files)
		pl_platformhook_package_files(${TARGET_NAME} ${SRC_FOLDER} ${DST_FOLDER})
	endif()
endfunction()