...
#else
  static_assert(sizeof(plPerLightData) == 64);
#endif
...
#else // C++
  static_assert(sizeof(plPerDecalData) == 96);
#endif
...
#define GET_REFLECTION_PROBE_INDEX(index) ((index) & REFLECTION_PROBE_INDEX_BITMASK)
...
#else // C++
  static_assert(sizeof(plPerReflectionProbeData) == 160);
#endif
  ...
  CONSTANT_BUFFER(plClusteredDataConstants, 3)
  {
    ...
    FLOAT1(SnowGlobalTransition);
    FLOAT1(SnowGlobalStrength);
    FLOAT1(SnowGlobalScale);
    FLOAT1(SnowBreakup);
    FLOAT1(SnowBreakupTiling);
    FLOAT1(SnowTiling);
};
